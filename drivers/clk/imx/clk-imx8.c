...
static struct imx8_clks imx8qm_clks[] = {
	...
	/* IWG27M: UART: Support for Debug LPUART4 clock */
	{ IMX8QM_UART4_DIV, "UART4_DIV", SC_R_UART_4, SC_PM_CLK_PER },
#endif
...
#ifdef CONFIG_TARGET_IMX8QM_IWG27M
	/* IWG27M: UART: Support for Debug LPUART4 clock */
	{ IMX8QM_UART4_CLK, "UART4_CLK", 0, LPUART_4_LPCG, IMX8QM_UART4_DIV },
	{ IMX8QM_UART4_IPG_CLK, "UART4_IPG", 16, LPUART_4_LPCG, IMX8QM_IPG_DMA_CLK_ROOT },
#endif
